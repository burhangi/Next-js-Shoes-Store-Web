// components/products/SimpleProductCard.tsx
"use client";
    ...
    >
      <Link href={`/products/${slug}`} className="block">
        ...
        <div className="relative aspect-square overflow-hidden bg-neutral-100">
          ...
          <div className={cn(
            "absolute bottom-3 left-3 right-3 flex gap-2 transition-all duration-300 transform",
            isHovered ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          )}>
            <button className="flex-1 px-3 py-2 bg-white text-neutral-900 text-xs font-medium rounded-lg shadow-md hover:shadow-lg flex items-center justify-center gap-1">
              <ShoppingBag className="w-3 h-3" />
              Add to Cart
            </button>
            <button className="w-8 h-8 bg-white text-neutral-900 rounded-lg shadow-md hover:shadow-lg flex items-center justify-center">
        ...
        <div className="p-4">
          ...
          <h3 className="font-semibold text-neutral-900 text-sm mb-2 line-clamp-2 h-10">
            {name}
          </h3>
